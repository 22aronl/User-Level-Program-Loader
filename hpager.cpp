...
// g++ -g -fpermissive -o hpager hpager.cpp magic.S -static -T layout.ld
...
void signalHandler(int signum, siginfo_t *info, void *context) {
    ...
    if(mmap((void *)page_start, page_size, PROT_READ | PROT_WRITE, MAP_PRIVATE | MAP_ANONYMOUS | MAP_FIXED, -1, 0) == MAP_FAILED) {
        perror("mmap");
        exit(EXIT_FAILURE);
    }
